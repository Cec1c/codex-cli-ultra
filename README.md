...
以下示例使用 `v0.1.26`，下载其他版本时将文件名替换为对应 Release 的名称。
...
| 组件 | 版本格式与来源 | 更新内容 |
| --- | --- | --- |
| CCU | `v0.1.26`；源码版本见 [package.json](package.json)，已发布版本见 [Releases](https://github.com/Cec1c/codex-cli-ultra/releases/latest) | 安装器、管理器、内容包与分发 |
