...
| --- | --- | --- |
| CCU | `v0.1.11` | Installer, manager, content, or documentation changes |
...
| Customization | Fresh installs enable the Macchiato-colored Hermes status line by default; upgrades preserve existing choices |
