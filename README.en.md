...
The examples below use `v0.1.26`. When downloading another version, replace the filenames with those from that Release.

Windows PowerShell 7:

```powershell
$archive = 'codex-cli-ultra-v0.1.26-windows-x64.zip'
...
```bash
archive='codex-cli-ultra-v0.1.26-linux-x64.zip'
...
```bash
archive='codex-cli-ultra-v0.1.26-macos-arm64.zip'
...
| --- | --- | --- |
| CCU | `v0.1.26`; see [package.json](package.json) for the source version and [Releases](https://github.com/Cec1c/codex-cli-ultra/releases/latest) for published builds | Installer, manager, content, and distribution |
